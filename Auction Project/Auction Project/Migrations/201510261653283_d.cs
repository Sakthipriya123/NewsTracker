                ...
                c => new
                    {
                        ...
                        NumberOfBids = c.Decimal(nullable: false, precision: 18, scale: 2),
                        BidderName = c.String(),
                    })
                .PrimaryKey(t => t.Id);
                ...
                c => new
                    {
                        ...
                        MinBid = c.Decimal(nullable: false, precision: 18, scale: 2),
                        MaxBid = c.Decimal(nullable: false, precision: 18, scale: 2),
                        auction_Id = c.Int(),
                    })
                .PrimaryKey(t => t.Id)
