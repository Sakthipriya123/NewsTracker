...
namespace ConsoleApplication2
{
    class Program
    {
        ...
        static int chips;
        static control.Deck deck;
        static List<control.Card> userHand;
        static List<control.Card> dealerHand;
        ...
        static void DealHand()
        {
            ...
            userHand = new List<control.Card>();
            userHand.Add(deck.DrawACard());
            userHand.Add(deck.DrawACard());

            foreach (control.Card card in userHand)
            {
                if (card.Face == control.Face.Ace)
                {
                    card.Value += 10;
                    break;
                }
            ...
            dealerHand = new List<control.Card>();
            dealerHand.Add(deck.DrawACard());
            dealerHand.Add(deck.DrawACard());

            foreach (control.Card card in dealerHand)
            {
                if (card.Face == control.Face.Ace)
                {
                    card.Value += 10;
            ...
            if (dealerHand[0].Face == control.Face.Ace)
            {
            ...
            if (dealerHand[0].Face == control.Face.Ace || dealerHand[0].Value == 10)
            {
